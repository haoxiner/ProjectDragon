...
bool PD::Display::Startup(int xResolution, int yResolution) {
...
bool PD::Display::Running() {
    return running_;
}

const PD::Input* PD::Display::GetInput() const {
    return &input_;
}